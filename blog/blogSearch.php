<?php include "../connect/connect.php";
    ...
    $sql = "SELECT b.blogID, b.blogTitle, b.blogContents, m.youName, b.blogRegTime, b.blogView FROM hyunBoard b JOIN hyunMember m ON(b.memberID = m.memberID)";
    ...
    if($result){
        ...
        if($count >0){
            for($i=0; $i<=$count; $i++){
                ...
                echo "<td><a href='blogView.php?blogID={$info['blogID']}'>".$info['blogTitle']."</a></td>";
...
<?php
  ...
  if($page != $endPage){
    ...
    // 마지막으로
    if($page != $endPage){
        echo "<li><a href='boardSearch.php?page={$endPage}&searchKeyword={$searchKeyword}&searchOption={$searchOption}'>마지막으로</a></li>";
    }
